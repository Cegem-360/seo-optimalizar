...
class PageSpeedAnalyze extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->info("Analyzing {$project->name} ({$project->url}) with {$strategy} strategy...");
        ...
        try {
            ...
            $this->error("Error analyzing PageSpeed: " . $e->getMessage());
            return 1;
        }
    }
