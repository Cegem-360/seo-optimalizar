...
return new class() extends Migration
{
    ...
    {
        $this->builder->create('competitor_rankings', function (Blueprint $blueprint): void {
            $blueprint->id();
            $blueprint->foreignId('competitor_id')->constrained()->cascadeOnDelete();
            ...
            $blueprint->index(['competitor_id', 'checked_at']);
    ...
    {
        $this->builder->dropIfExists('competitor_rankings');
    }
};
