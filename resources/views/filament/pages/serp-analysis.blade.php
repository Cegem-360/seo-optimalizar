...
<div class="space-y-6">
        ...
        <!-- Betöltés animáció -->
        @if($this->isLoading)
            <div class="relative overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-8 text-white shadow-2xl">
        ...
        @if(count($this->analysisResults) > 0)
            <div class="space-y-8">
                @foreach($this->analysisResults as $result)
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100" wire:key="result-{{ $loop->index }}">
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                ...
                                @if(isset($analysis['position_rating']))
                                    <div class="bg-gradient-to-br 
                                        ...
                                        @else from-gray-50 to-slate-100 border-gray-300
                                        @endif
                                        border-2 rounded-2xl p-5 relative overflow-hidden">
                                        <div class="absolute top-0 right-0 -mt-4 -mr-4 w-20 h-20 
                                        ...
                                        <div class="relative">
                                            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Értékelés</p>
                                ...
                                @if(isset($analysis['target_position']))
                                    <div class="bg-gradient-to-br from-indigo-50 to-purple-100 border-2 border-indigo-300 rounded-2xl p-5 relative overflow-hidden">
                                        <div class="absolute top-0 right-0 -mt-4 -mr-4 w-20 h-20 bg-indigo-200 rounded-full opacity-20"></div>
                                        <div class="relative">
                                            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Célpozíció</p>
                                            <p class="text-2xl font-black text-indigo-700">{{ $analysis['target_position'] }}. hely</p>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @foreach($analysis['main_competitors'] as $index => $competitor)
                                            <div class="group relative">
                                                <div class="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-xl blur opacity-25 group-hover:opacity-40 transition"></div>
                                                <div class="relative bg-white border border-purple-200 rounded-xl px-4 py-2 flex items-center space-x-2 hover:border-purple-400 transition">
                                                    <span class="text-xs font-bold text-purple-500">{{ $index + 1 }}.</span>
                                                    <span class="text-sm font-semibold text-gray-700">{{ $competitor }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="space-y-4">
                                ...
                                @if(!empty($analysis['competitor_advantages']))
                                    <details class="group">
                                        <summary class="flex items-center justify-between cursor-pointer bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 rounded-xl p-4 hover:border-red-300 transition">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-600">{{ count($analysis['competitor_advantages']) }} elem</p>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="space-y-2">
                                                @foreach($analysis['competitor_advantages'] as $advantage)
                                                    <li class="flex items-start">
                                                        <span class="inline-block w-2 h-2 bg-red-400 rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                                ...
                                @if(!empty($analysis['quick_wins']))
                                    <details class="group" open>
                                        <summary class="flex items-center justify-between cursor-pointer bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-xl p-4 hover:border-emerald-300 transition">
                                            <div class="flex items-center">
                                ...
                                @if(!empty($analysis['improvement_areas']))
                                    <details class="group">
                                        <summary class="flex items-center justify-between cursor-pointer bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4 hover:border-blue-300 transition">
                                            <div class="flex items-center">
                                ...
                                @if(!empty($analysis['detailed_analysis']))
                                    <div class="bg-gradient-to-br from-gray-50 to-slate-100 border-2 border-gray-200 rounded-xl p-6">
                                        ...
                                        <div class="prose prose-sm max-w-none">
                                            <p class="text-gray-700 leading-relaxed">{{ $analysis['detailed_analysis'] }}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
        ...
        @elseif(!$this->isLoading)
            ...
            <div class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-12 text-center overflow-hidden">
                <div class="absolute inset-0">
                    <div class="absolute -top-4 -right-4 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-blob"></div>
                    <div class="absolute -bottom-8 -left-4 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-blob animation-delay-2000"></div>
                    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-blob animation-delay-4000"></div>
                </div>
                
                <div class="relative max-w-md mx-auto">
                    <div class="w-20 h-20 bg-white rounded-2xl shadow-lg mx-auto mb-6 flex items-center justify-center">
